      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <a href="add-transaction.php" class="btn btn-md btn-success" style="margin-bottom: 10px">TAMBAH TRANSACTION</a>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="d-flex justify-content-around">
                        <a href="edit-transaction.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary mr-1">EDIT</a>
                        <a href="remove-transaction.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>
